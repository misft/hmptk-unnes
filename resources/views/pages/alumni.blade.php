        ...
        <div class="container">
            <div class="form-jarak">
                <div class="form-alumni">
                    ...
                    <br><br>
                    <form action="/post_alumni" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="nomor" class="form-control" placeholder="Masukkan Nomor Telepon..."
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="jenjang" class="form-control" placeholder="Masukkan Jenjang..."
                        ...
                        <div class="input-group mb-3">
                            ...
                            <textarea class="form-control" name="alamat_rumah" aria-label="With textarea"></textarea>
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                            ...
                            <textarea class="form-control" name="alamat_bekerja" aria-label="With textarea"></textarea>
                        </div>
                        <br>
                        <div class="text-center">
